...
namespace Auth0Demo.UWP
{
    ...
    {
        public static Auth0.LoginClient.Auth0User ConvertToSdkType(this MappedTypes.Auth0User localType)
        {
            var result = Mapper.Map<Auth0.LoginClient.Auth0User>(localType);
        ...
        public static MappedTypes.Auth0User ConvertLocalType(this Auth0.LoginClient.Auth0User sdkType)
        {
