    ...
    sealed partial class App : Application
    {
        ...
        void InitializeAutoMapper()
        {
            Mapper.Initialize(cfg => {
                cfg.CreateMap<Auth0.LoginClient.Auth0User, MappedTypes.Auth0User>();
                cfg.CreateMap<MappedTypes.Auth0User, Auth0.LoginClient.Auth0User>();
            });
        }

        // We're using AutoFac as an IoC container for executing platform-specific behaviors from the cross-platform Xamarin.Forms project (Auth0Demo).
